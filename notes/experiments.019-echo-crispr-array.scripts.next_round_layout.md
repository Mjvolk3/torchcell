...
Generated by `experiments/019-echo-crispr-array/scripts/p2_reference_diagnosis.py`.
Output: `results/run3_p2_reference_diagnosis.csv`.

![Is the P2 WT anomaly positional?](assets/images/019-echo-crispr-array/p2_reference_diagnosis.svg)
...
Generated by `experiments/019-echo-crispr-array/scripts/verify_plate_pairing.py`.
...
Generated by `experiments/019-echo-crispr-array/scripts/generate_picklist.py`.
Outputs: `experiments/019-echo-crispr-array/picklists/`.
