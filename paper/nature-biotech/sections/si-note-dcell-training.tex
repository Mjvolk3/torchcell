...
deleted genes, done once per term and per strain. Light bars, share of the step's host time
(Python plus kernel launches) per phase; dark bars, share of the GPU kernel time; the phases
partition the step. The step takes 30.6~s untraced (118~s under the tracer, which is why
