...
\begin{itemize}[leftmargin=1.2em,itemsep=1pt,topsep=2pt]
  \item \term{S288C-KO} -- the reference genome minus one cataloged ORF (BY4741, BY4742,
    BY4743). Thirteen of the sixty in Table~\ref{tab:final} sit here, second only to reference-only.
...
the two bands total 53 rows, so they fill the fifty and three of them become the first
three of the ten extra, and no scale row reaches the fifty at all. de Boer 2020 sits at 54
and Lee 2014 at 56. Both are the largest things in the ranking by instance count and both
are in the extra ten, which is the deliberate consequence of ordering by what a row
combines with rather than by how many numbers it holds. A reader who wants scale back
reads rows 54 to 60 first.
