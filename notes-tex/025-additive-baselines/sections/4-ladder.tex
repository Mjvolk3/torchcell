...
validation maximum. Within each arm, a light bar is a test score and a dark bar a
validation maximum with no test score. Only B5 carries an error bar, the standard
...
the disjoint null moves with the choice of
