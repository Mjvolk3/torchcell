...
def main():
    ...
    with open("experiments/001-dmi-tmi/query.cql", "r") as f:
        query = f.read()
    ...
    # TODO will have to change as this was build for fitness.
    deduplicator = ExperimentDeduplicator()
    dataset_root = osp.join(DATA_ROOT, "data/torchcell/experiments/002-dmi-tmi")
