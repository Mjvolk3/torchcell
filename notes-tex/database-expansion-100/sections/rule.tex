...
\begin{itemize}[leftmargin=1.2em,itemsep=1pt,topsep=2pt]
  \item \term{S288C-KO} -- the reference genome minus one cataloged ORF (BY4741, BY4742,
    BY4743). Thirty-six of the recommended 151 sit here, the largest single group.
...
The cut at 151 is arithmetic, $200-49$, not a quality threshold. Rows on both sides of it
...
the set stays auditable. No pin is currently in force: at 151 rows the recommended set is
wide enough that every requested dataset ranks inside it unaided.
