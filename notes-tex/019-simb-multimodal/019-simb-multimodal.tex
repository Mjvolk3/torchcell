%% notes-tex/019-simb-multimodal/019-simb-multimodal.tex
%% [[experiments.019-simb-multimodal.phenotype-strand-retrospective]]
%% https://github.com/Mjvolk3/torchcell/tree/main/notes-tex/019-simb-multimodal/019-simb-multimodal.tex
%%
...
%%
%% Build:  make            -> 019-simb-multimodal.pdf         (draft: status chips + provenance flags)
%%         make clean-view -> 019-simb-multimodal-clean.pdf   (share view)
...
\input{sections/10-launch}

%% What the launched rounds returned is NOT here. The expression strand continues in
%% notes-tex/019-simb-multimodal-expression/ (readouts of 2026-09-08 onward), so that this
%% document stays the reviewed six-strand retrospective and the campaign has its own record.
