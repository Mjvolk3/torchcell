...
# [[experiments.024-perturb-seq-costing.scripts.read_structure]]
# https://github.com/Mjvolk3/torchcell/tree/main/experiments/024-perturb-seq-costing/scripts/read_structure
