...
# [[experiments.024-perturb-seq-costing.scripts.effect_size_analysis]]
# https://github.com/Mjvolk3/torchcell/tree/main/experiments/024-perturb-seq-costing/scripts/effect_size_analysis
