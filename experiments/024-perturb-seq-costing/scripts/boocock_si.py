# experiments/024-perturb-seq-costing/scripts/boocock_si.py
# [[experiments.024-perturb-seq-costing.scripts.boocock_si]]
# https://github.com/Mjvolk3/torchcell/tree/main/experiments/024-perturb-seq-costing/scripts/boocock_si
...
Run:  python experiments/024-perturb-seq-costing/scripts/boocock_si.py
      python experiments/024-perturb-seq-costing/scripts/boocock_si.py --fetch
...
RESULTS = osp.join(EXPERIMENT_ROOT, "024-perturb-seq-costing", "results")
