...
Ledger of all 45 comments: `notes-tex/microbe-perturb-seq/review/round-2-dispositions.md`.
...
stays `notes-tex/microbe-perturb-seq/`, since it is named for its subject and the
Makefile's `PLOT_SLUG` is what ties it to the experiment.
