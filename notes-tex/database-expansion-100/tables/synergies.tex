...
\addlinespace[5pt]
43 & Blank 2005 (13C metabolic flux) & \textbf{Kemmeren 2014} & deletion strains present in both & Flux against expression for the same knockout, which is the only place the transcript-to-flux step can be fitted rather than assumed. \\
...
\addlinespace[5pt]
56 & Nguyen Ba 2022 (barcoded bulk QTL, 100k segregants) & \textbf{Bloom 2019 (16-parent cross)} & segregant genotype class, panel size & One cross at 100,000 progeny against sixteen founders at 14,000, which separates panel size from allelic diversity. \\
\addlinespace[5pt]
