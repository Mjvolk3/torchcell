...
from torchcell.models.cell_latent_perturbation_tform import CellLatentPerturbation
...
@hydra.main(
    ...
    config_name="cell_latent_perturbation_tform_regression",
)
    ...
    wandb.log(
        {
            ...
            "model/params_whole_intact_processor": param_counts[
                "whole_intact_processor"
            ],
