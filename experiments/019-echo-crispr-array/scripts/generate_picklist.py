# experiments/019-echo-crispr-array/scripts/generate_picklist.py
# [[experiments.019-echo-crispr-array.scripts.generate_picklist]]
# https://github.com/Mjvolk3/torchcell/tree/main/experiments/019-echo-crispr-array/scripts/generate_picklist
