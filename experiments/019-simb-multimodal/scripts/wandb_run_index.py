...
a table without appearing here, and vice versa:
  ...
  - results/listmle_round_readout.csv       the ranking-objective round (same script,
                                            `--round listmle`)
...
ROUNDS = ("incumbent", "objective", "mechanism", "pearson", "listmle", "v10")
ROUND_LABEL = {
...
ARM_ORDER = {
    ...
    "listmle": ["Q_listmle", "Q_listmle_mse", "Q_listmle_b64"],
}
...
def load_runs() -> list[RunRecord]:
    ...
    for fname, rnd in (("mech_round_readout.csv", "mechanism"),
                       ...
                       ("listmle_round_readout.csv", "listmle")):
...
def write_table(index: RunIndex) -> None:
    lines = [
        ...
        "%% mech_round_readout.csv, pearson_round_readout.csv, listmle_round_readout.csv,",
        "%% v10_grid_factorial.csv.",
