...
\tcfigfit[1.0]{figures/eqtl-experiment-and-genotype-inference.pdf}{%
  ...
  \textbf{d}, The map that results. Cis effects fall on the diagonal, each variant acting on
  its own gene and usually through its promoter; trans hotspots appear as vertical bands
  where one regulatory variant moves hundreds of transcripts.
