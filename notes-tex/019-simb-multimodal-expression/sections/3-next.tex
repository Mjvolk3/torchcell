...
\file{calm} against \file{prot_T5_all}, three seeds each at 1{,}000 epochs, resolves a gap
of about $0.03$ at the within-cell replicate sd of $0.012$ to $0.025$ measured in the v10
grid, and is the cheapest contrast left on the table: six runs of under a day each. It
would also give the first true replicate spread of the incumbent configuration, which the
eight long-budget arms only bound.
