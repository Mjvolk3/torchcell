...
The best validation Pearson recorded on this target is $0.430$ in study
\file{betaxanthin_002}, at $47\,\%$ of that ceiling, with the top five configurations in
close agreement rather than one lucky trial. The cell carried forward for the head-to-head
below is \file{s09_L6_maskon_lr0.0001_yj}, selected by validation at $0.3639$ and
never by its score on the held-out comparison genes.
