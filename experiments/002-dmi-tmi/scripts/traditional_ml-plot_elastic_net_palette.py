# experiments/002-dmi-tmi/scripts/traditional_ml-plot_elastic_net_palette
# [[experiments.002-dmi-tmi.scripts.traditional_ml-plot_elastic_net_palette]]
# https://github.com/Mjvolk3/torchcell/tree/main/experiments/002-dmi-tmi/scripts/traditional_ml-plot_elastic_net_palette
...
def create_plots(
    ...
    # draw.io (line, fill) pairs: bar faces = line/border color, hatch + edge = black.
    line_dict = {f: c for f, c in zip(FEATURE_ORDER, PLOT_PALETTE[: len(FEATURE_ORDER)])}
    fill_dict = {f: c for f, c in zip(FEATURE_ORDER, PLOT_PALETTE_FILL[: len(FEATURE_ORDER)])}
    ...
    for metric in metrics:
        ...
        plot_name = f"002-dmi-tmi_Elastic_Net_{size_str}_{criterion}_{metric}_{'add_cv' if add_cv else 'no_cv'}_palette.svg"
...
def main(is_overwrite=False):
    ...
    if is_overwrite:
        ...
        project_names = [
            "zhao-group/torchcell_002-dmi-tmi_trad-ml_elastic_net_1e03",
            "zhao-group/torchcell_002-dmi-tmi_trad-ml_elastic_net_1e04",
            "zhao-group/torchcell_002-dmi-tmi_trad-ml_elastic_net_1e05",
        ]
