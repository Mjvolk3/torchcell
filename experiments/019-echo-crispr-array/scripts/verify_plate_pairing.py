# experiments/019-echo-crispr-array/scripts/verify_plate_pairing.py
# [[experiments.019-echo-crispr-array.scripts.verify_plate_pairing]]
# https://github.com/Mjvolk3/torchcell/tree/main/experiments/019-echo-crispr-array/scripts/verify_plate_pairing
