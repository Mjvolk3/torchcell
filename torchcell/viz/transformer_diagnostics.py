...
class TransformerDiagnostics:
    ...
    def plot_attention_diagnostics(
        ...
        residual_ratios: dict[int, float] | None = None,
        qk_logit_stats: dict[int, dict[str, float]] | None = None,
        ...
        ax2.set_title(
            "Attention Concentration (Effective Rank)", fontsize=14, fontweight="bold"
        )
        ...
        ax4.set_title(
            "Max Row Weight (One-Hot Detection)", fontsize=14, fontweight="bold"
        )
        ...
        ax5.set_title(
            "Column Concentration (Sink Collapse Detection)",
            fontsize=14,
            fontweight="bold",
        )
        ...
        ax6.set_title(
            "Residual Update Ratio (Layer Health)", fontsize=14, fontweight="bold"
        )
