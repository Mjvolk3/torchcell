...
CURATED: list[CuratedRow] = [
    ...
    CuratedRow(section="Environmental / chemogenomic", name="Vanacloig-Pedros 2022", genotypes="3,647", env="41", phenotype="chemogenomic fitness (log2-ratio)", data_subpath="data/torchcell/env_chemgen_vanacloig2022"),
