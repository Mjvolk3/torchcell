...
\section{Introduction\cb{target ~570 words}\wc{intro}\secstatus{tent}}\label{sec:intro}
...
from almost any gene representation, yet fail on gene interactions (\suppfig{fig:classical-ml})---so
...
outline the data model and architecture in \suppfig{fig:overview}.
