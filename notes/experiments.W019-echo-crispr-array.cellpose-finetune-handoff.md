...
- **Benchmark** `experiments/W019-echo-crispr-array/scripts/costanzo_kuzmin_comparison.py`:
...
misses. Steps:
  ...
  1. New script `experiments/W019-echo-crispr-array/scripts/cellpose_finetune_prep.py`:
  ...
  2. New script `cellpose_finetune.py` calling `train.train_seg` (params above), save to
     `experiments/W019-echo-crispr-array/models/cpsam_echo_ft`. GPU via a `gh_*.slurm`
