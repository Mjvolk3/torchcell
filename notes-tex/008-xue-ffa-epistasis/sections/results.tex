...
genome-scale model from stearate, with the genes of that path under its name. None of the
ten deleted regulators is a gene of the map or of the model: the deletions act on
metabolism from outside it. All thirteen pathway genes of
panel \textbf{b} are drawn. The map's own labels are not reproduced; at this size
...
interactions (blue, above) and only the negative ones (brick, below). The negatives reach all 45 pairs and every factor,
