...
\tcfigfit[1.0]{figures/eqtl-experiment-and-genotype-inference.pdf}{%
  ...
  (Sec.~\ref{sec:built}): the genotype is a \file{SegregantGenotype}, a sibling of
  \file{Genotype} holding the mosaic as haplotype blocks against two pinned parent
  assemblies, and the QTL table is not stored.
