...
- [ ] Solve speed issue with loader by using a cpu loader. Current issue is that the iteration speeds are super low because we are not using multiprocessing on loading datasets for building `train`, `val`, `test` → 
