...
most of them not measured here; and one measurement at one metabolic locus therefore
reports the combined effect of many small unmeasured changes, which is scored as an
emergent deviation. None of the three is tested in the mirrored literature, and the
...
(\suppnoteref{note:fluxmodel}). Until the measured comparison exists, the honest form of
the claim is that interaction was pervasive in a regulator panel measured at one metabolic
locus, that a nonlinear map from the perturbed layer to the measured one is sufficient to
produce it, and that neither the amount nor the sign is predicted from the panel's
distance to the readout.
