...
measured, in either direction. The run that measures it is queued: job 1609 on
GilaHyper trains the replication configuration on the 025 query-pair-disjoint
split (Section~\ref{sec:disjoint025}), and the baselines it will be read
against are already in Table~\ref{tab:disjoint025}.
