...
\Cref{sec:routes} is what the bench actually does on each of the three
routes, including the preindexed one the program is aiming at.
...
\input{sections/1-plan}
\input{sections/2-routes}
\input{sections/3-nadal}
\input{sections/4-open}
\input{sections/5-checkpoints}
