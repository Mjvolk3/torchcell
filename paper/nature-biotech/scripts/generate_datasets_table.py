...
DATASET_ROWS: list[DatasetRow] = [
    ...
    DatasetRow(section="Morphology", name="Ohya 2005 (SCMD CalMorph)", genotypes="4,718", env="1", phenotype="cell morphology", label="k-vector", shape="n×k", data_subpath="database/data/torchcell/scmd_ohya2005"),
    DatasetRow(section="Expression (microarray)", name="Kemmeren 2014", genotypes="1,450", env="1", phenotype="mRNA log2(mut/wt)", label="~6,000-gene vector", shape="n×~6000", data_subpath="data/torchcell/microarray_kemmeren2014"),
