#!/bin/bash
# experiments/W019-echo-crispr-array/scripts/gh_cellpose_detection_sweep.sh
# [[experiments.W019-echo-crispr-array.scripts.gh_cellpose_detection_sweep]]
#
...
#   bash experiments/W019-echo-crispr-array/scripts/gh_cellpose_detection_sweep.sh "P1_t50,P2_t72"
# then read the overlays + slurm/output/*.out RECIPE_JSON to pick a winner.

set -euo pipefail
CONDS="${1:-P1_t50,P2_t72}"
WRAP="experiments/W019-echo-crispr-array/scripts/gh_cellpose_recipe.slurm"
