...
rebuilt input rather than an operator on a shared encoding. One triple deletion is drawn,
Q0140, YJL171C, YPR204W (three genes with the median eight direct annotations, chosen by
rule): dashed red, the zeroed gene states entering the subsystems that annotate them (open
circles); solid red, every hierarchy edge from those subsystems up to the root, the
