...
def create_plots(
    ...
    for metric in metrics:
        ...
        plot_name = f"Elastic_Net_{max_size_str}_{criterion}_{metric}_{'add_cv' if add_cv else 'no_cv'}.png"
        title = f"Elastic Net {max_size_str} {criterion} {metric} {'with CV' if add_cv else 'without CV'}"
