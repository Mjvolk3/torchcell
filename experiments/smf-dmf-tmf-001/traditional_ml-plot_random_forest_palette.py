# RECOLORED COPY of traditional_ml-plot_random_forest.py -- same plots, TorchCell palette,
# outputs suffixed _palette. Regenerate offline (reads cached combined_df CSVs).
import numpy as np
import pandas as pd
import wandb
...
def create_plots(
    ...
    for metric in metrics:
        fig, ax = plt.subplots(figsize=(2.276, 6.5))  # Increase figure size
        ...
        plot_name = f"smf-dmf-tmf-001_Random_Forest_{max_size_str}_{criterion}_{metric}_{'add_cv' if add_cv else 'no_cv'}_palette.svg"
