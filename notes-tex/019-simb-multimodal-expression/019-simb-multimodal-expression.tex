...
the eight long-budget runs of the v9 mask-schedule round, which spread $0.0222$ around a
mean of $0.1965$ at the full budget. Those eight were taken for identical-config
replicates until 2026-09-08; they are eight arms, and their spread bounds the replicate
spread from above rather than measuring it.
...
the long-budget band rather than above it. The one factor that moves the score by more
than the replicate spread is the content of the gene embedding, ProtT5 over random by
$0.07$ at 1,000 epochs against a within-cell replicate sd of $0.025$; trunk depth, readout
width and weight decay do not. The per-gene readout is
