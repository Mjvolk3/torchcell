# experiments/008-xue-ffa/scripts/best_titers_per_ffa_distribution_comparison
# [[experiments.008-xue-ffa.scripts.best_titers_per_ffa_distribution_comparison]]
# https://github.com/Mjvolk3/torchcell/tree/main/experiments/008-xue-ffa/scripts/best_titers_per_ffa_distribution_comparison
# Test file: experiments/008-xue-ffa/scripts/test_best_titers_per_ffa_distribution_comparison.py
...
def create_distribution_comparison(
    ...
    plt.suptitle('Distribution Comparison: Singles vs Doubles vs Triples',
...
def create_triple_vs_best_double_plot(
    ...
    plt.suptitle('Triple Mutant Performance vs Best Constituent Double',
                fontsize=16, fontweight='bold')
    plt.tight_layout()
...
def analyze_top_performer_composition(
    ...
    plt.suptitle(f'Composition Analysis of Top {top_percentage}% Performers (n={n_top_strains} strains)',
                fontsize=16, fontweight='bold')
    plt.tight_layout()
