...
perturb ($\mathcal{T}_\psi$), and decode ($\mathcal{R}_\phi$) into labeled instances
...
\bmhead{Drug exposure and robustness of the learned cell representation\cb{~380 words}\wc{r-robust}}
