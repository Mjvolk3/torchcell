...
stages 6 and 7 add \texttt{torch.compile} to stage 5 at batch 500 and 600. Two reruns of
the stage-5 configuration on later days (99 and 119~s per step) are not drawn: the shared
machine drifts from day to day by more than several optimizations, so only same-sitting
stages compare.
