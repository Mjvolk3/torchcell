# experiments/022-mulleder-metabolome/scripts/train_metabolism.py
# [[experiments.022-mulleder-metabolome.scripts.train_metabolism]]
# https://github.com/Mjvolk3/torchcell/tree/main/experiments/022-mulleder-metabolome/scripts/train_metabolism
...
Usage (one target per GPU):
    ...
    python experiments/022-mulleder-metabolome/scripts/train_metabolism.py \
