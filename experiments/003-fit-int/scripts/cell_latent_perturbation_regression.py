...
from torchcell.models.cell_latent_perturbation import CellLatentPerturbation
...
@hydra.main(
    ...
    config_name="cell_latent_perturbation_regression",
)
def main(cfg: DictConfig) -> None:
    print("Starting HeteroGnnPool 🏴‍☠️")
    ...
    elif wandb.config.cell_dataset["graph_processor"] == "unperturbed":
    ...
    dataset = Neo4jCellDataset(
        ...
        graphs=graphs,
        incidence_graphs=incidence_graphs,  # Add metabolism
    ...
    conv_type = wandb.config.model["gene_encoder_conv_type"]
    layer_config = {}
    ...
    model = CellLatentPerturbation(
        ...
        # Gene encoder params
        gene_encoder_num_layers=wandb.config.model["gene_encoder_num_layers"],
        gene_encoder_conv_type=conv_type,
        gene_encoder_layer_config=layer_config,
        gene_encoder_head_num_layers=wandb.config.model["gene_encoder_head_num_layers"],
        # Metabolism processor params
        metabolism_num_layers=wandb.config.model["metabolism_num_layers"],
        metabolism_attention=wandb.config.model["metabolism_attention"],
        metabolism_hyperconv_layers=wandb.config.model["metabolism_hyperconv_layers"],
        metabolism_setnet_layers=wandb.config.model["metabolism_setnet_layers"],
        metabolism_use_skip=wandb.config.model["metabolism_use_skip"],
        # Set processor params
        set_transformer_heads=wandb.config.model["set_transformer_heads"],
        set_transformer_layers=wandb.config.model["set_transformer_layers"],
        set_net_node_layers=wandb.config.model["set_net_node_layers"],
        set_net_set_layers=wandb.config.model["set_net_set_layers"],
        # Combiner params
        combiner_num_layers=wandb.config.model["combiner_num_layers"],
        combiner_hidden_factor=wandb.config.model["combiner_hidden_factor"],
        # Head params
        head_hidden_factor=wandb.config.model["head_hidden_factor"],
    ...
    wandb.log(
        {
            "model/params_gene_encoder": param_counts["gene_encoder"],
            "model/params_metabolism_processor": param_counts["metabolism_processor"],
            "model/params_combiner": param_counts["combiner"],
            "model/params_whole_intact_processor": param_counts["whole_intact_processor"],
            "model/params_perturbed_processor": param_counts["perturbed_processor"],
            "model/params_fitness_head": param_counts["fitness_head"],
            "model/params_gene_interaction_head": param_counts["gene_interaction_head"],
