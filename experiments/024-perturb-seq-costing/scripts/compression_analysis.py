# experiments/024-perturb-seq-costing/scripts/compression_analysis.py
# [[experiments.024-perturb-seq-costing.scripts.compression_analysis]]
# https://github.com/Mjvolk3/torchcell/tree/main/experiments/024-perturb-seq-costing/scripts/compression_analysis
...
a guide barcode is seen in a read, because there are no guides in it.
    ...
    python experiments/024-perturb-seq-costing/scripts/compression_analysis.py

Outputs to experiments/024-perturb-seq-costing/results/:
