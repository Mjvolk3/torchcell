...
| Dataset | Genotypes | Env | Phenotype | Label | Shape | Signal (gzip) |
| :-- | --: | --: | :-- | :-- | :-- | --: |
| Kemmeren 2014 | 1,484 | 1 | mRNA log2(mut/wt) | ~6,000-gene vector | n×~6000 | 395.8 MB |
...
| Dataset | Genotypes | Env | Phenotype | Label | Shape | Signal (gzip) |
| :-- | --: | --: | :-- | :-- | :-- | --: |
| Caudal 2024 (pan-transcriptome) | 943 | 1 | RNA-seq TPM (natural isolates) | ~6,445-gene vector | 943×~6445 | 94.1 MB |
