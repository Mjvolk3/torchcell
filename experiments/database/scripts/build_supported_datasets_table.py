...
CURATED: list[CuratedRow] = [
    ...
    CuratedRow(section="Environmental / chemogenomic", name="Auesukaree 2009 (stress screen)", genotypes="333", env="6", phenotype="stress sensitivity (categorical: sensitive/no_change)", data_subpath="data/torchcell/env_chemgen_auesukaree2009"),
    CuratedRow(section="Environmental / chemogenomic", name="Mota 2024 (weak-acid screen)", genotypes="601", env="3", phenotype="weak-acid susceptibility (ordinal: 0/1/2 grades)", data_subpath="data/torchcell/env_chemgen_mota2024"),
    CuratedRow(section="Environmental / chemogenomic", name="Vanacloig-Pedros 2022 (chemogenomic fitness)", genotypes="3,647", env="41", phenotype="chemogenomic fitness (log2-ratio)", data_subpath="data/torchcell/env_chemgen_vanacloig2022"),
    ...
    CuratedRow(section="Environmental / chemogenomic", name="Hillenmeyer 2008 (FitDb HIP, het)", genotypes="5,814", env="514", phenotype="HIP fitness-defect log2-ratio", data_subpath="data/torchcell/env_chemgen_hillenmeyer2008_het"),
    CuratedRow(section="Environmental / chemogenomic", name="Hillenmeyer 2008 (FitDb HOP, hom)", genotypes="4,667", env="279", phenotype="HOP fitness-defect z-score", data_subpath="data/torchcell/env_chemgen_hillenmeyer2008_hom"),
    CuratedRow(section="Environmental / chemogenomic", name="Wildenhain 2015 (drug tolerance)", genotypes="256", env="5,168", phenotype="growth-inhibition z-score", data_subpath="data/torchcell/env_chemgen_wildenhain2015"),
    CuratedRow(section="Environmental / chemogenomic", name="Hoepfner 2014 (HIP/HOP atlas)", genotypes="10,779", env="563", phenotype="HIP/HOP sensitivity score", data_subpath="data/torchcell/env_chemgen_hoepfner2014"),
    ...
    CuratedRow(section="Environmental / chemogenomic", name="Smith 2016 (CRISPRi chem-genetic)", genotypes="1,035", env="8", phenotype="chemogenomic fitness (log2-ratio)", data_subpath="data/torchcell/crispri_chemgen_smith2016"),
    ...
    CuratedRow(section="Expression (microarray)", name="Kemmeren 2014 (deletion compendium)", genotypes="1,484", env="1", phenotype="mRNA log2(mut/wt)", data_subpath="data/torchcell/microarray_kemmeren2014"),
