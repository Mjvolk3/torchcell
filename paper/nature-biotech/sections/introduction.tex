...
the same readout spans applications from suppressing proliferation in disease to maximising
...
data-standardisation spirit of TorchGeo~\cite{stewartTorchGeoDeepLearning2022a}, together with the Cell
