# experiments/W019-echo-crispr-array/scripts/plate_artifacts.py
# [[experiments.W019-echo-crispr-array.scripts.plate_artifacts]]
# https://github.com/Mjvolk3/torchcell/tree/main/experiments/W019-echo-crispr-array/scripts/plate_artifacts
...
Non-destructive: writes ONLY under experiments/W019-echo-crispr-array/artifacts/, never the
...
Run from repo root on a GPU node:
    ~/miniconda3/envs/torchcell/bin/python \
        experiments/W019-echo-crispr-array/scripts/plate_artifacts.py [run2|run3|all]
"""
...
SEG_CFG = dict(
    ...
    node_tol=0.60, edge_margin_frac=0.70, multi_min_frac=0.35,
)
...
def process_collection(name: str, model_holder: dict) -> None:
    ...
    readme = pd.DataFrame([
        ("collection", name),
        ("generated_by", "experiments/W019-echo-crispr-array/scripts/plate_artifacts.py"),
