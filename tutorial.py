...
genome["YFL039C"].window_three_prime(300)
genome["YFL039C"].window_three_prime(300, allow_undersize=True)
genome["YFL039C"].window_three_prime(300, allow_undersize=False)
