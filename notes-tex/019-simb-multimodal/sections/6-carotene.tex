...
epochs. The best validation \file{spearman_per_feature} is $\mathbf{0.132}$, run
...
signal, at $0.132$ against a chance level of zero, and its best run peaks late (epoch 799 of
...
$0.132$ is a quarter of achievable or most of it. That gap is resolvable only with a
