# experiments/004-dmi-tmi/scripts/hetero_cell_bipartite_dango_gi
# [[experiments.004-dmi-tmi.scripts.hetero_cell_bipartite_dango_gi]]
# https://github.com/Mjvolk3/torchcell/tree/main/experiments/004-dmi-tmi/scripts/hetero_cell_bipartite_dango_gi
# Test file: experiments/004-dmi-tmi/scripts/test_hetero_cell_bipartite_dango_gi.py
...
def main(cfg: DictConfig) -> None:
    ...
    with open(
        osp.join(EXPERIMENT_ROOT, "004-dmi-tmi/queries/001_small_build.cql"), "r"
    ) as f:
        query = f.read()
