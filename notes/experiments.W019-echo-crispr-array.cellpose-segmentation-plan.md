...
`experiments/W019-echo-crispr-array/cellpose_test/P2_5nL_t72_crop_center.png`). Much of the edge
...
![Cellpose cyto3 (zero-shot) on the full-res P2 5 nL 72 h crop: original, predicted outlines (tight to each colony), instance masks (one colour per colony), and cell-pose flow.](assets/images/W019-echo-crispr-array/cellpose/cellpose_org_demo_P2_5nL_t72_crop.png)

Downloaded instance-mask PNG for reference:
`assets/images/W019-echo-crispr-array/cellpose/P2_5nL_t72_crop_center_cellpose_masks.png`.
...
- rsync (from this M1 machine; adjust host alias as configured):
  ...
  ```bash
  rsync -avP \
    experiments/W019-echo-crispr-array/data/run2_2026-07-17/ \
    gila:/home/michaelvolk/Documents/projects/torchcell/torchcell-scratch/W019-echo-crispr-array/run2_2026-07-17/
  ```
...
- Test crop: `experiments/W019-echo-crispr-array/cellpose_test/P2_5nL_t72_crop_center.png`
...
- **`experiments/W019-echo-crispr-array/scripts/run2_cellpose_segmentation.py`** (new): imports the
  ...
  overlays to `assets/images/W019-echo-crispr-array/cellpose/`.
- **`experiments/W019-echo-crispr-array/scripts/gh_cellpose_segmentation.slurm`** (new): GilaHyper
...
- Data moved M1 -> gila via rsync (30 files) to
  `/home/michaelvolk/Documents/projects/torchcell/torchcell-scratch/W019-echo-crispr-array/data/`;
