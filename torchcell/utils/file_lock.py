...
class FileLockHelper:
    ...
    def read_json_with_lock(
        ...
        try:
            ...
            log.error(
                f"Failed to acquire lock for reading {file_path} within {timeout}s"
            )
            raise
    ...
    def write_json_with_lock(
        ...
        try:
            ...
            log.error(
                f"Failed to acquire lock for writing {file_path} within {timeout}s"
            )
            raise
    ...
    def update_json_with_lock(
        ...
        try:
            ...
            log.error(
                f"Failed to acquire lock for updating {file_path} within {timeout}s"
            )
            raise
