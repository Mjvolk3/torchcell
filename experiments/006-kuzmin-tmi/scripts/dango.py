# experiments/006-kuzmin-tmi/scripts/dango
# [[experiments.006-kuzmin-tmi.scripts.dango]]
# https://github.com/Mjvolk3/torchcell/tree/main/experiments/006-kuzmin-tmi/scripts/dango
# Test file: experiments/006-kuzmin-tmi/scripts/test_dango.py
...
def main(cfg: DictConfig) -> None:
    ...
    log.info(
        f"Using {scheduler_type} scheduler with transition_epoch={transition_epoch}"
    )
