...
def create_plots(
    ...
    for metric in metrics:
        ...
        plot_name = f"smf-dmf-tmf-001_Elastic_Net_{max_size_str}_{criterion}_{metric}_{'add_cv' if add_cv else 'no_cv'}_palette.svg"
...
def main(is_overwrite=False):
    ...
    if is_overwrite:
        ...
        project_names = [
            "zhao-group/torchcell_smf-dmf-tmf-001_trad-ml_elastic_net_1e03",
            "zhao-group/torchcell_smf-dmf-tmf-001_trad-ml_elastic_net_1e04",
            "zhao-group/torchcell_smf-dmf-tmf-001_trad-ml_elastic_net_1e05",
        ]
