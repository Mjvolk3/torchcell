# experiments/008-xue-ffa/scripts/best_titers_per_ffa_cost_benefit
# [[experiments.008-xue-ffa.scripts.best_titers_per_ffa_cost_benefit]]
# https://github.com/Mjvolk3/torchcell/tree/main/experiments/008-xue-ffa/scripts/best_titers_per_ffa_cost_benefit
# Test file: experiments/008-xue-ffa/scripts/test_best_titers_per_ffa_cost_benefit.py
...
def create_cost_benefit_analysis(
    ...
    plt.suptitle('Cost-Benefit Analysis: Number of Knockouts vs Fitness',
                fontsize=16, fontweight='bold')
    plt.tight_layout()

    # Save figure
    filename = "multiplicative_cost_benefit_analysis.png"
...
def create_marginal_benefit_summary(
    ...
    plt.suptitle('Marginal Benefit Analysis Across FFAs',
                fontsize=16, fontweight='bold')
    plt.tight_layout()

    # Save figure
    filename = "multiplicative_marginal_benefit_summary.png"
    ffa_dir = osp.join(ASSET_IMAGES_DIR, "008-xue-ffa")
    os.makedirs(ffa_dir, exist_ok=True)
    filepath = osp.join(ffa_dir, filename)
    fig.savefig(filepath, dpi=300, bbox_inches="tight")
