...
## 2026.09.18 - Review round 8: heights back, and headroom for panel c's key

The measured panels are 52 mm again and the level sets 40 mm, since the schematic row left for Fig. 1. Panel c's y axis now runs to 4.5 times the largest replicate SD so the three-row key sits above every point; at 38 mm it sat on the constant-spread line.
