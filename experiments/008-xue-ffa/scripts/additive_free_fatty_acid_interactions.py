...
def save_interaction_results(digenic_interactions, digenic_sd, digenic_se, digenic_pvalues, digenic_fdr,
    ...
    digenic_df.to_csv(osp.join(results_dir, "additive_digenic_interactions_3_delta_normalized.csv"), index=False)
    trigenic_df.to_csv(osp.join(results_dir, "additive_trigenic_interactions_3_delta_normalized.csv"), index=False)
    combined_df.to_csv(osp.join(results_dir, "additive_all_interactions_3_delta_normalized.csv"), index=False)
    ...
    # Save JSON summary
    import json
    summary_json_file = osp.join(results_dir, "additive_interaction_summary.json")
...
def main():
    ...
    filename1 = "additive_ffa_distributions_and_volcano_3_delta_normalized.png"
    ...
    filename2 = "additive_ffa_significance_summary_3_delta_normalized.png"
