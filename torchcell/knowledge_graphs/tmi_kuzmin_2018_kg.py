# torchcell/knowledge_graphs/tmi_kuzmin_2018_kg.py
# [[torchcell.knowledge_graphs.tmi_kuzmin_2018_kg]]
# https://github.com/Mjvolk3/torchcell/tree/main/torchcell/knowledge_graphs/tmi_kuzmin_2018_kg
# Test file: tests/torchcell/knowledge_graphs/test_tmi_kuzmin_2018_kg.py
...
def main(cfg):
    ...
    dataset = TmiKuzmin2018Dataset(
        root=osp.join(DATA_ROOT, "data/torchcell/tmi_kuzmin2018"),
