...
\notesec{And the training set was a quarter of what exists} Every morphology run in the
project reports $n_{\mathrm{train}} = 1{,}161$ and $n_{\mathrm{val}} = 132$. The Ohya
screen holds 4,718 deletions, and only 1,440 of them also carry expression. The morphology
configs set \file{require_modalities: [expression_log2_ratio, calmorph]}, which pins
every arm to that intersection.
